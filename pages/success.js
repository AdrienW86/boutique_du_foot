...
export default function success() {
  ...
  <>
    <div className={styles.container}>
      ...
      <p className={styles.email}> Nous vous remercions d'avoir effectué vos achats chez nous et espérons que vos produits vous donnerons entière satisfaction.</p>
